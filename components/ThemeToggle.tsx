...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <button
        className="p-2 rounded hover:bg-retro-primary/10 transition-colors"
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded hover:bg-retro-primary/10 transition-colors focus:outline-none focus:ring-2 focus:ring-retro-primary rounded"
      // T054: ARIA label with current state
